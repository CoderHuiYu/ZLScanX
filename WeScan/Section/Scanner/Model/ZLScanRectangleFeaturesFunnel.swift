//
//  ZLScanRectangleFeaturesFunnel.swift
//  WeScan
//
...
final class ZLScanRectangleFeaturesFunnel {
    ...
    private final class RectangleMatch: NSObject {
        ...
        let rectangleFeature: ZLQuadrilateral
        ...
        init(rectangleFeature: ZLQuadrilateral) {
        ...
        func matches(_ rectangle: ZLQuadrilateral, withThreshold threshold: CGFloat) -> Bool {
    ...
    let startShootLoadingThreshold = 5
    ...
    func add(_ rectangleFeature: ZLQuadrilateral, currentlyDisplayedRectangle currentRectangle: ZLQuadrilateral?, completion: (AddResult, ZLQuadrilateral, Int) -> Void) {
    ...
    private func bestRectangle(withCurrentlyDisplayedRectangle currentRectangle: ZLQuadrilateral?) -> RectangleMatch? {
    ...
    private func breakTie(between rect1: RectangleMatch, rect2: RectangleMatch, currentRectangle: ZLQuadrilateral) -> RectangleMatch {
