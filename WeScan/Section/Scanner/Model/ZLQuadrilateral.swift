...
public struct ZLQuadrilateral: ZLTransformable {
    ...
    func applying(_ transform: CGAffineTransform) -> ZLQuadrilateral {
        let quadrilateral = ZLQuadrilateral(topLeft: topLeft.applying(transform), topRight: topRight.applying(transform), bottomRight: bottomRight.applying(transform), bottomLeft: bottomLeft.applying(transform))
    ...
    func isWithin(_ distance: CGFloat, ofRectangleFeature rectangleFeature: ZLQuadrilateral) -> Bool {
    ...
    func scale(_ fromSize: CGSize, _ toSize: CGSize, withRotationAngle rotationAngle: CGFloat = 0.0) -> ZLQuadrilateral {
...
extension ZLQuadrilateral {
    ...
    func toCartesian(withHeight height: CGFloat) -> ZLQuadrilateral {
        ...
        return ZLQuadrilateral(topLeft: topLeft, topRight: topRight, bottomRight: bottomRight, bottomLeft: bottomLeft)
    }
    // rotate rect
    func rotateRect() -> ZLQuadrilateral {
        
        let topLeft = self.topLeft
        let topRight = self.topRight
        let bottomRight = self.bottomRight
        let bottomLeft = self.bottomLeft
        ...
        let rRect = ZLQuadrilateral(topLeft: rTopLeft, topRight: rTopRight, bottomRight: rBottomRight, bottomLeft: rBottomLeft)
        
        return rRect
    }
}

extension ZLQuadrilateral: Equatable {
    public static func == (lhs: ZLQuadrilateral, rhs: ZLQuadrilateral) -> Bool {
